...
[![npm version](https://badge.fury.io/js/theme-switcher.svg)](https://www.npmjs.com/package/theme-switcher)
...
// Basic usage
const result = switcher('your input here');
console.log(result);
```
...
```javascript
const { switcher, batch } = require('theme-switcher');

// Single item
const result = switcher('hello');
